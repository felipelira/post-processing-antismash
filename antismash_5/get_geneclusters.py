...
"""
inside the output directory generated by Antismash 5

usage : python get_geneclusters.py directory_with_results

"""

#TODO modify to use it accessing the directory

in_dir = sys.argv[1]
path = os.path.realpath(in_dir)
out_name = "geneclusters.txt" #  "in_dir + ".geneclusters.txt"
